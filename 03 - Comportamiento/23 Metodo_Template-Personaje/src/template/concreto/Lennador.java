...
public class Lennador extends Personaje{
	private int _GastoEstamina;

	public Lennador(String _Nombre, int _Estamina, boolean _Activo) {
		super(_Nombre, _Estamina, _Activo);
		this._GastoEstamina = 8;
	}
	...
	protected String ejecutarAccion() {
		if(this.is_Activo()) {
			...
			return "Seguimos cortando lenna";
		}else
